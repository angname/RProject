...
import com.thinksky.photoscan.NativeImageLoader;
import com.thinksky.photoscan.NativeImageLoader.NativeImageCallBack;
...
public class ChildAdapter extends BaseAdapter {
    ...
    public ChildAdapter(Context context, List<String> list, GridView mGridView, FinalBitmap finalBitmap) {
        this.list = list;
