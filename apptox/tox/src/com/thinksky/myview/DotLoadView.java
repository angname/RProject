 ...
 */
public class DotLoadView extends TextView{
    protected JumpingSpan dotOne;
    private JumpingSpan dotTwo;
    private JumpingSpan dotThree;

    protected int showSpeed = 700;
    ...
    public DotLoadView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public DotLoadView(Context context, AttributeSet attrs, int defStyleAttr) {
